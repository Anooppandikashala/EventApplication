...
public class UpcomingEvent extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        listView = (ExpandableListView)view.findViewById(R.id.list_upcoming);
        textView = view.findViewById(R.id.noupevents);
        ...
        UpcomingEvent.BackgroundTask backgroundTask = new UpcomingEvent.BackgroundTask();
    ...
    class BackgroundTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            addInfoUrl = "http://palaeobotanical-com.000webhostapp.com/upcoming.php";
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                int l;
                l=listAdapter.getGroupCount();
                if (l==0)
                    textView.setText("No Upcoming Events");
